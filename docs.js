var docs = docs || {
    ...
    cdoc: document.querySelector(".docs-texteventtarget-iframe").contentDocument,

    clip: window.navigator.clipboard,
...
docs.getSelectionEl = function() {
    var selection = null;
    // Try to find the selection overlay using a more general selector
    $(".kix-selection-overlay, .kix-htmlselection-overlay").each(function() {
        if (selection !== null) return;

        // Check if this element is visible and has a non-zero size
        var isVisible = $(this).is(":visible");
        var hasSize = $(this).width() > 0 && $(this).height() > 0;
